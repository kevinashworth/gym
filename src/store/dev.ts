...
interface DevActions {
  // for development
  toggleEnableMockGeoLocation: () => void;
...
const initialState: DevState = {
  enableMockGeoLocation: Boolean(process.env.EXPO_PUBLIC_ENABLE_MOCK_LOCATION),
